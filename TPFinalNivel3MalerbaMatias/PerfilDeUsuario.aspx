...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="col-8 ms-5">
        <div class="mt-3 mb-5">
            <h1>Perfil de </h1>
            <h1 id="HeaderNombreDeUsuario" runat="server"></h1>
        </div>
        <div class="row">
            <div class="col-4">
                <div class="mb-3">
                ...
                <div class="mb-5">
                    ...
                    <label id="lblTipoDeUsuario" class="form-label" runat="server">Consumidor Final</label>
                </div>
        ...
        <div class="mt-3">
            ...
            <asp:Button CssClass="btn btn-danger" ID="btnCerrarPerfil" Text="Cerrar Sesión" OnClick="btnCerrarPerfil_Click" runat="server" />
        </div>
    </div>
</asp:Content>
